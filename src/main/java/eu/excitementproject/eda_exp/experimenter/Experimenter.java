...
import eu.excitementproject.eda_exp.data.DataHandling;
...
//			System.out.println("Language: " + language);
	...
	private void test(HashMap<String, HashMap<String, Set<PairXMLData>>> data, String model) {
		...
		String[] args =  new String[] {"-config", options.config, "-test", "-testFile", tmpTestFile, "-output", options.output, "-score"};
